...
const styles = StyleSheet.create({
  ...
  iconContainer:  { width: 42, height: 42, borderRadius: 21, justifyContent: 'center', alignItems: 'center', marginRight: 12 },
  textContainer:  { flex: 1 },
  title:          { fontWeight: 'bold', fontSize: 15, marginBottom: 2 },
  body:           { fontSize: 13 },
  closeButton:    { padding: 4, marginLeft: 8 },
  progressContainer: { height: 3, backgroundColor: 'rgba(0,0,0,0.1)' },
